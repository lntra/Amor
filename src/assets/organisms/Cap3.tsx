...
const Cap2 = () => {
    ...
    <div className="reading-page-container text-black">
        ...
        <h1 className="flex justify-center items-center font-bold">Capítulo 3: Tempestade</h1>
        </div>
        ...
        <p>
            Tempestade em um copo de água, tempestade no coração do gatinho,
            ouvir essas palavras o fez tremer de montão, afinal, e se ela não tivesse a mesma intenção?
            Reunindo todas as forças ele o disse.
        </p>
        <hr className="my-5"/>
        <p>
            - Quero alguém pra criar memórias, e pelo que conheci de você, fariamos ótimas histórias.
        </p>
        </div>
