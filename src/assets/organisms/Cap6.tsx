...
const Cap2 = () => {
    ...
    <div className="reading-page-container text-black">
        ...
        <h1 className="flex justify-center items-center font-bold">Capítulo 6: Separação</h1>
        </div>
        ...
        <p>
            Gatinha já não via ele da mesma forma, apesar de gatinho ser o mesmo, eventos recentes também a assombravam,
            amor ainda existia, mas apenas com isso, a união se manteria?
        </p>
        <hr className="my-5"/>
        <p>
            Gatinho foi uma pessoa terrível, sem igual, maltratar a pessoa mais importante, mesmo sendo leal.
        </p>
        </div>
