...
const Cap2 = () => {
    ...
    <div className="reading-page-container text-black">
        ...
        <h1 className="flex justify-center items-center font-bold">Capítulo 2: Inesperado</h1>
        </div>
        ...
        <p>
            De surpresa, o gatinho quase teve um infarto, aparentemente ela havia se interessado, 
            muito tempo então, gatinho e gatinha passavam juntinhos, até que em um fatídico dia
            gatinha o perguntou. 
        </p>
        <hr className="my-5"/>
        <p>
